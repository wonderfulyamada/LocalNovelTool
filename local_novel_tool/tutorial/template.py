...
TUTORIAL_PROJECT = {'format_version': 1,
 ...
 'plot_items': [{'id': 'plot_37c72ea3f7ac',
                 'title': '町へ到着',
                 'content': '雨の中、旅の主人公がサンプルの町へ着く。宿で荷車が消えたと聞き、白雨の由来にもつながる事件の気配を知る。',
                 'chapter_id': None,
                 'episode_id': None},
                {'id': 'plot_45047e46e58e',
                 'title': '事件に巻き込まれる',
                 'content': '川辺に残る荷車の跡を追った主人公は、町の外へ向かった犯人の足取りをつかむ。次に書く場面と必要な手掛かりをここで確認する。',
                 'chapter_id': None,
                 'episode_id': None},
                {'id': 'plot_7ca02956d1c6',
                 'title': '犯人を追う',
                 'content': '白雨を手にした主人公が、雨で薄れかけた道をたどり犯人を追う。町の人々を巻き込まずに事件を終える方法を選ぶ。',
                 'chapter_id': None,
                 'episode_id': None}],
 'timeline_items': [{'id': 'time_db9c62d2da7a',
                     'point': '2年前',
                     'title': '主人公が故郷を出る',
                    'content': '白雨だけを携え、旅を続けることを決めた。'},
                    {'id': 'time_85901c5f1cc2', 'point': '半年前', 'title': '事件が発生', 'content': 'サンプルの町で荷車が消える事件が断続的に起き始める。'},
                    {'id': 'time_434c505c445b', 'point': '現在', 'title': '物語開始', 'content': '雨の朝、主人公が町へ到着し、宿で事件を聞く。'}]}

TUTORIAL_TEXT_FILES = {'episode_notes/ep_037e1b8a80a0.txt': '',
 'episode_notes/ep_207c62d33433.txt': '',
 'episode_notes/ep_524b3cfa827d.txt': '* この話でやること: 宿で荷車の事件を聞く\n'
                                      '* 登場人物: 主人公、宿の女将\n'
                                      '* 次話への引き: 川辺の足跡を見つける\n'
                                      '* 忘れたくない描写: 白雨の鞘に残る雨粒',
 ...
 'manuscript/ep_c22ec88b6044.txt': 'ルビは「｜白雨《しらさめ》」のように入力します。プレビューで横書き・縦書きを切り替えてみましょう。\n\n雨は夜まで止まなかった。宿場町の石畳を踏むたび、旅人の靴底から小さな水音がした。\n\n主人公は腰の｜白雨《しらさめ》に手を添え、灯りの少ない通りを見渡した。町へ入る前、道端で荷車を探す男に会ったのだ。\n\n「今夜だけで二台目です」\n\n宿の女将は戸口からそう言った。消えた荷車は川の方へ向かったらしい。主人公は濡れた鞘を拭い、朝まで待つべきか考えた。\n\n遠くで鐘が一度鳴った。その音に混じって、川辺から木が軋むような音がした。主人公は提灯を借り、白雨を置いたままではいられないと知った。',
 'manuscript/ep_c63ffb49978a.txt': '「本文」タブは小説の文章を書く場所です。入力した内容は自動保存され、Ctrl+Sでも保存できます。\n\n夕暮れのサンプルの町は、雨上がりの匂いに包まれていた。主人公は門をくぐり、宿の看板を見上げる。\n\n荷車が消えたという噂は、門番の短いひと言から始まった。困っている人を放っておけない主人公は、宿へ向かう足を少しだけ速めた。\n\n【試してみよう】\nこの下に一文書く → 左の別の話へ移動する → この話へ戻る、の順に操作して、文章が残っていることを確認してください。',
 ...
 'references/ref_526d374a4bb0.txt': '主人公が持つ刀。読みは「しらさめ」。雨に濡れると刃文が淡く見える。事件を追う場面で使う。',
 'references/ref_99b40084f87a.txt': '旅人が集まる小さな宿場町。川沿いの荷車置き場で、最近は荷車が消える事件が起きている。',
 'references/ref_d96af9993972.txt': '町へ来たばかりの旅人。困っている人を放っておけない。書く時は考える前に一歩動く性格を意識する。',
 'references/ref_dde2cfa0e2f6.txt': '分類に迷った情報や、あとで整理したい断片を自由に置けます。白雨の由来など後で決める設定にも使えます。'}
